    ...
    useEffect(() => {
        const handleGetTrendingMovies = async () => {
            try {
                ...
                const response = await axios.get(`https://api.themoviedb.org/3/movie/now_playing?page=${currentPage}&api_key=${apiKey}`, config);
    ...
    <div className="w-full flex flex-col">
      <div className="w-full flex flex-row">
        <div className="basis-1/2 flex justify-start pl-2 font-Manrope font-bold text-2xl">
          <p className="pl-6">Movies Playing Right Now:</p>
        </div>
